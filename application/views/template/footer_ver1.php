        ...
        <footer id="footer">
            <div class="container">
                <div class="col-md-4 col-sm-6" style="color: #ffffff;">
                    ...
                    <p>For more about us click <span id="ft_link"><a href="<?php echo base_url() ;?>index.php/about" style="color: #ffffff;">here</a></span></p>
...
_________________________________________________________ -->
        ...
        document.write(today.getFullYear() );
                ...
                <div class="col-md-4">
                	...
                	<?php echo anchor_popup('https://jlkconsulting.info', 'JLK Consulting'); ?></p>
                </div>
                <div class="col-md-4">
